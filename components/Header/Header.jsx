...
export function Header() {
  return (
    <header className="flex h-24 items-center px-8 bg-white shadow-lg">
      ...
      <button className="flex items-center gap-2 text-start text-teal-600 hover:text-teal-500 transition-colors ml-auto">
        <Image width="48" height="48" alt="avatar" src={avatar} unoptimized />
        <div>
